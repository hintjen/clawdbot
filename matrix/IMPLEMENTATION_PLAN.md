...
- [x] Create `src/channels/plugins/onboarding/matrix.ts` with matrixOnboardingAdapter
- [x] Add Matrix option to onboarding wizard
...
- [x] `src/channels/plugins/onboarding/matrix.ts`
